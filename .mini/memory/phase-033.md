# Phase 33 — Plausible analytika bez inline

**Goal:** Do web klienta se přidá měření Plausible: externí skript v index.html a init v linkovaném TS modulu (žádný inline blok, CSP-čisté).

## Steps
- [done] Modul analytics.ts s Plausible init
- [done] Typy pro window.plausible
- [done] Externí async skript v index.html
- [done] Import analytics v main.ts
- [done] Ověření buildu + CHANGELOG
