# Phase 40 — Oznamovací box natrvalo nad deskou

**Goal:** Panel se stavem a tlačítky posadit natrvalo do toku nad hrací desku na šířku desky i na desktopu (stejně jako na mobilu), odstranit text „kdo je na tahu“ (řeší barva kamene) i řádek se soupeřem .level-info (řeší přepínač).

## Steps
- [done] DOM: obalit desku a indikátor do .board-row
- [done] CSS desktop: panel v toku nad deskou
- [done] CSS: svislé vejití panel + deska
- [done] CSS mobil: pročistit @media (max-width:768px)
- [done] TS: vyčistit obsah panelu
