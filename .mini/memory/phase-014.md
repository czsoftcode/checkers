# Phase 14 — Search jádro enginu (M3)

**Goal:** Engine vybírá tah pomocí negamaxu s alfa-beta ořezáváním na pevnou hloubku a evaluací v1 (muž 100, dáma 130, bonus za zadní řadu, drobný postup vpřed) - brána: vybírá pouze legální tahy a v sérii partií poráží random hráče.

## Steps
- [done] Evaluace v1 jako čistá funkce
- [done] Negamax s alfa-beta na pevnou hloubku
- [done] Zapojení do handleru bestmove
- [done] Brána: série partií proti random hráči
- [done] Integrační test podprocesu a poznámka k limitům
